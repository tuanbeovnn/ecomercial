...
export default (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case FETCH_PRODUCT_BY_BRAND : {
            copyState.productBrand = action.products;
            copyState.total = action.total;
            copyState.currentPage = action.currentPage;
            return copyState;
        }

        case FETCH_PRODUCT_CATEGORY_BY_BRAND : {
            copyState.categoryByBrand = action.products;
            copyState.total = action.total;
            copyState.currentPage = action.currentPage;
            return copyState;
        }
