                                        ...
                                        <div className="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div className="card-body">
                                                <form>
                                                    ...
                                                    <div className="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a className="small" href="password.html">Forgot Password?</a><a className="btn btn-primary" href="index.html">Login</a></div>
                                                </form>
                                            </div>
